...
class BERT_LONG_DEPEND(BERT_SEGBOT): 
  def init_hook(self):
    # self.bi_gru_batch_first = nn.LSTM(self.bert_size, self.hidden_size, batch_first=True, bidirectional=True)
    self.bi_lstm_batch_first = nn.GRU(self.bert_size, self.hidden_size, batch_first=True, bidirectional=True)
