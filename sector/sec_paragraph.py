...
def sec_para_standard_1vs1():
  ...
  for i in range(20):
    G['m'] = m = Sec_Para_Standard_One_Sep_Use_Cls(learning_rate = 5e-6, ss_len_limit = 2, auxiliary_loss_rate = -1.0)
    get_datas_early_stop_and_parameter_ajust(i, 3, f'Early Stop, Standard 1vs1', url = panther_url)
